...
"""Shim: re-export the ``_spectralweave`` submodule of the aggregated extension.
...
private ``navette._spectralweave`` import path stable and lazily loads the
extension only when this submodule is imported.
"""

from __future__ import annotations

from navette._navette import _spectralweave as _ext
