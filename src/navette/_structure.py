...
"""Shim: re-export the ``_structure`` submodule of the aggregated extension.
...
private ``navette._structure`` import path stable and lazily loads the
extension only when this submodule is imported.
"""

from __future__ import annotations

from navette._navette import _structure as _ext
