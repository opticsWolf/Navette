# -*- coding: utf-8 -*-
"""Shim: re-export the ``_materials`` submodule of the aggregated extension.
...
private ``navette._materials`` import path stable and lazily loads the
extension only when this submodule is imported.
"""

from __future__ import annotations

from navette._navette import _materials as _ext
