...
"""Shim: re-export the ``_color`` submodule of the aggregated extension.
...
private ``navette._color`` import path stable and lazily loads the
extension only when this submodule is imported.
"""

from __future__ import annotations

from navette._navette import _color as _ext
